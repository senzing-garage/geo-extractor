...
"""
# -----------------------------------------------------------------------------
# geo-extractor.py Example python skeleton.
...
def get_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        prog="geo-extractor.py",
        description="Add description. For more information, see https://github.com/senzing-garage/geo-extractor",
    )
