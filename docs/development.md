...
1. Run docker container.
   ...
   ```console
   docker run --rm senzing/geo-extractor
...
1. Verify that `geo-extractor` is not installed.
   Example:

   ```console
   python3 -m pip freeze | grep -e geo-extractor -e geo_extractor
...
1. Verify that `geo-extractor` is installed.
   Example:
   ...
   > geo-extractor @ file:///home/senzing/senzing-garage.git/sz-sdk-python-abstract/dist/geo_extractor-0.0.1-py3-none-any.whl#sha256=2a4e5218d66d5be60ee31bfad5943e6611fc921f28a4326d9594ceceae7e0ac1
...
1. Uninstall the `geo-extractor` python package.
   Example:

   ```console
   python3 -m pip uninstall geo-extractor
